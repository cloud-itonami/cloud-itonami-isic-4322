# Operator Quickstart — Community Plumbing and HVAC Installation

Shortest path from clone to a verified local dry-run for **ISIC 4322** (`cloud-itonami-isic-4322`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4322.git
cd cloud-itonami-isic-4322
```
...
- Blueprint governor key: `plumbing-trade-governor`
- Likely source path: `src/**/plumbing-trade-governor.cljc`
